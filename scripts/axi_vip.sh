...
# Script info
echo -e "axi_vip.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
compile()
{
  ...
  xvlog $xvlog_opts -prj vlog.prj 2>&1 | tee logs/compile.log
...
elaborate()
{
  ...
  -log logs/elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  # xsim axi_vip -key {Behavioral:sim_1:Functional:axi_vip} -tclbatch cmd.tcl -protoinst "protoinst_files/axi_vip.protoinst" -log simulate.log
  # xsim tb_axi_vip -key {Behavioral:sim_1:Functional:tb_axi_vip} \
  # -tclbatch cmd.tcl \
